...
namespace MinifyERPBilling.Models
{
    ...
    using SQLHelper;
    class PurchaseVoucherModel:DbContext
    {
        ...
        public DataSet PurchaseOperation()
        {
            SqlParameter[] sql = new SqlParameter[13];
            sql[0] = new SqlParameter("@Action", this.Action);
            sql[1] = new SqlParameter("@PurchaseDocId", this.PurchaseDocId);
            ...
            sql[6] = new SqlParameter("@PurchaseAccountId", this.PurchaseAccountId);
            ...
            return SqlHelper.ExecuteDataset(con, CommandType.StoredProcedure, "PurchaseVoucer_Operations", sql);
        }
    }
}
